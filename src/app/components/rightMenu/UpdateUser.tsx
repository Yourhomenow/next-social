    ...
    <div className="">
      ...
      {open && (<div className="absolute w-screen h-screen top-0 left-0 bg-black bg-opacity-65 flex items-center justify-center z-50">
        ...
        >
          ...
          <div className="flex flex-wrap justify-between gap-2 xl:gap-4">
            ...
            <div className="flex flex-col gap-4">
              ...
              <input 
                type="text" 
                className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm" 
                placeholder={user.city || "Palo Alto"} 
                name="city"
              />
            </div>
            {/* INPUT */}
            ...
            <div className="flex flex-col gap-4">
              ...
              <input 
                type="text" 
                className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm" 
                placeholder={user.school || "Stanford"} 
                name="school"
              />
            </div>
            {/* INPUT */}
            ...
            <div className="flex flex-col gap-4">
              ...
              <input 
                type="text" 
                className="ring-1 ring-gray-300 p-[13px] rounded-md text-sm" 
                placeholder={user.website || "www.you.com"} 
                name="website"
              />
            </div>
          </div>
          <UpdateButton/>
          {state.success &&(
            <span className="text-green-500">Profile has been update!</span>
          )}
          {state.error && (
